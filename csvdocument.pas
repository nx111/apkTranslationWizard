...
begin
  ...
  if (FCurrentChar = CR) and (not InSpecCell) then
    NextChar;
  if (FCurrentChar = LF) and (not InSpecCell) then
    NextChar;
end;
...
begin
  ...
  EndOfLine := (FCurrentChar in LineEndingChars) and (not InSpecCell);
end;
...
begin
  ...
  InSpecCell:=(FCurrentChar = FQuoteChar);
